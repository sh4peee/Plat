...
map_data_1 = []
map_data_2 = []
with open('level_1.json', 'r') as file:
    map_data_1 = json.load(file)

with open('level_2.json', 'r') as file:
    map_data_2 = json.load(file)
...
if game.currently_level == 1:
    ...
    for y, row in enumerate(map_data_1):
    ...
    for y, row in enumerate(map_data_2):
        for x, cell in enumerate(row):
            if cell == 1:
                platform_x = x * platform_width
                platform_y = y * platform_height
